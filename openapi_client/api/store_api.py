...
class StoreApi:
    ...
    def get_order_by_id(
        self,
        order_id: Annotated[int, Field(le=10, strict=True, ge=1, description="ID of book that needs to be fetched")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param order_id: ID of book that needs to be fetched (required)
        :type order_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def place_order(
        self,
        body: Annotated[Order, Field(description="order placed for purchasing the book")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param body: order placed for purchasing the book (required)
        :type body: Order
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
